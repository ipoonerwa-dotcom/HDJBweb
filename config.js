...
window.JIEBEI_ABI = {
  VAULT: [
    ...
    "function safetyReserveBps() view returns (uint256)",
    "function kBps() view returns (uint256)",
    "function singleCapBps() view returns (uint256)",
    "function collateralCapBps() view returns (uint256)",
