...
const dict = {
  zh: {
    ...
    "mech.s2.t": "一键借出 BNB",
    "mech.s2.d": "合约用 Portal + TWAP 双层预言机定价，示例：抵押 1 BNB 市值代币最高可借 0.3 BNB，300 秒倒计时启动。",
    "mech.s3.t": "履约 or 焚毁",
  ...
  en: {
    ...
    "hero.cta1": "🦋 Launch DApp",
    "hero.cta2": "Read Mechanism →",
    "hero.t1.l": "Buy Tax",
    "hero.t2.l": "Sell Tax",
    "hero.t3.l": "To Vault",
    "hero.t4.l": "Window",
    ...
    "mech.s2.d": "Two-layer Portal+TWAP oracle prices your stake. Example: stake 1 BNB worth, borrow up to 0.3 BNB. 300-second timer starts.",
